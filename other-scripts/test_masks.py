...
def main():
    ...
    image_path1 = ""  # Path to an example input image
    image_path2 = ""  # Path to an example input image
    image_path3 = ""  # Path to an example input image
    image_path4 = ""  # Path to an example input image
