...
# File path
file_path = "training_results.txt"  # point to correct results file...
...
def plot_boxplots(metrics, filename="boxplot.png"):
    ...
    plt.title("Model 5: Boxplots of Metrics")
...
def plot_credible_intervals(runs, filename="credible_intervals.png"):
    ...
    plt.title("Model 5: Bayesian Credible Intervals Over Training Runs with Mean Values")
