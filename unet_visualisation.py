...
def save_feature_maps_as_png(feature_maps, output_path="feature_maps.png"):
    ...
    fig_height = num_layers * 0.8  # Adjust height based on the number of layers
...
def main():
    ...
    model_path = 'final_models/checkpoint_F14.pth'  # Path to your trained model
    ...
    #save_scattering_coefficients(input_tensor, J=2, L=8)
