...
# File path
file_path = "training_results_F10.1.txt"
...
def plot_boxplots(metrics, filename="boxplot.png"):
    ...
    plt.title("Model 10.1: Boxplots of Metrics")
...
def plot_credible_intervals(runs, filename="credible_intervals.png"):
    ...
    plt.title("Model 10.1: Bayesian Credible Intervals Over Training Runs with Mean Values")
