...
def load_model(model_path):
    model = UNet(n_channels=3, n_classes=1, bilinear=False, J=1, L=16, input_shape=(128, 128))
...
def main():
    model_path = './final_models/4/checkpoint_epoch50.pth'  # Path to your trained model
