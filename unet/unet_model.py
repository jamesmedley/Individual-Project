...
class UNet(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        self.skip_upconv2 = (SkipDoubleUpConv(n_input_channels, 128))
        self.skip_upconv3 = (SkipUpConv(n_input_channels, 256))
