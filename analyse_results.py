...
# File path
file_path = "DRIVE)training_results_J2.txt"
...
def plot_boxplots(metrics, filename="boxplot.png"):
    ...
    plt.title("Scat-UNet-J2 (DRIVE): Boxplots of Metrics")
...
def plot_credible_intervals(runs, filename="credible_intervals.png"):
    ...
    plt.title("Scat-UNet-J2 (DRIVE): Bayesian Credible Intervals Over Training Runs with Mean Values")
