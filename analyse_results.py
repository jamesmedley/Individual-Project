...
# File path
file_path = "training_results_F12.txt"
...
def plot_boxplots(metrics, filename="boxplot.png"):
    ...
    plt.title("Model 12: Boxplots of Metrics")
...
def plot_credible_intervals(runs, filename="credible_intervals.png"):
    ...
    plt.title("Model 12: Bayesian Credible Intervals Over Training Runs with Mean Values")
