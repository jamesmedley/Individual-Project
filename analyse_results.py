...
# File path
file_path = "training_results_J2(skip all).txt"
...
def plot_boxplots(metrics, filename="boxplot.png"):
    ...
    plt.title("Model 15: Boxplots of Metrics")
...
def plot_credible_intervals(runs, filename="credible_intervals.png"):
    ...
    plt.title("Model 15: Bayesian Credible Intervals Over Training Runs with Mean Values")
