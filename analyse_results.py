...
# File path
file_path = "DRIVE_Scat-UNet-J1.txt"
...
def plot_boxplots(metrics, filename="boxplot.png"):
    ...
    plt.title("Scat-UNet-J1 (DRIVE): Boxplots of Metrics")
...
def plot_credible_intervals(runs, filename="credible_intervals.png"):
    ...
    plt.title("Scat-UNet-J1 (DRIVE): Bayesian Credible Intervals Over Training Runs with Mean Values")
