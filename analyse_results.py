...
# File path
file_path = "DRIVE_training_results_UNet.txt"
...
def plot_boxplots(metrics, filename="boxplot.png"):
    ...
    plt.title("U-Net (DRIVE): Boxplots of Metrics")
...
def plot_credible_intervals(runs, filename="credible_intervals.png"):
    ...
    plt.title("U-Net (DRIVE): Bayesian Credible Intervals Over Training Runs with Mean Values")
