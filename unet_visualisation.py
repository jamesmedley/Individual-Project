...
def main():
    #model_path = './Demos/3_unet_50-60/checkpoint_epoch10.pth'  # Path to your trained model
    model_path = './Demos/9_unet_scat_(single)_50-60/checkpoint_epoch10.pth'  # Path to your trained model
