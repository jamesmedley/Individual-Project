...
# File path
file_path = "dtcwt_(avg-pool)_training_results.txt"
...
def plot_boxplots(metrics, filename="boxplot.png"):
    ...
    plt.title("DTCWT-UNet (DRIVE): Boxplots of Metrics")
...
def plot_credible_intervals(runs, filename="credible_intervals.png"):
    ...
    plt.title("DTCWT-UNet (DRIVE): Bayesian Credible Intervals Over Training Runs with Mean Values")
